...
class Ui_MainWindow_interaction(object):
    ...
    def on_update_image(self):
        ...
        self.load_img(img_path)  # "/home/prtricardo/tese_ws/GUI/odm_orthphoto.png"
...
if __name__ == "__main__":
    ...
    Ui_interaction = Ui_MainWindow_interaction(ui, global_vars)
    Ui_dit = Ui_Data_Import_Tab(global_vars, Ui_MainWindow)
